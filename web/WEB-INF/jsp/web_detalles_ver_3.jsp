    ...
    <body>
        <div id="pages">
            ...
            <section class="header-login-interno hei-top">
                <div class="container">
                    <div class="logo">
                        <a href="web_inicio.html"><img src="images/logo.png"/></a>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="pull-left">
                            ...
                            <div class="pull-right rlogin">
                                <div class="tit-derecha-1 ina">
                                    <a href="web_home_sespad.html" class="tab-a">
                                        <span>SESPAD</span>
                                    </a>
                                </div>
                                ...
                                <div class="row top-row">
                                    <div class="col-xs-12 nopadding">
                                        <div class="pull-right sprincipal top-right">
                                            ...
                                            <button type="submit" class="disnone btn btn-default btn-orange-filtro">EXPORTAR REPORTE</button>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 nopadding">
